                        ...
                        <div className='md:grid grid-cols-2'>
                            <div className="block w-[90%] mx-auto py-2 lora text-[14px] tracking-[1.5px]">
                                <div className="flex flex-col items-start justify-center w-full py-2 md:py-[10px] ">
                                    ...
                                    <div readOnly type='text' className="w-full p-2 text-[13px] outline-none">{profileApiData?.name}</div>
                                </div>
                            </div>
                            <div className="block w-[90%] mx-auto py-2 lora text-[14px] tracking-[1.5px]">
                                <div className="flex flex-col items-start justify-center w-full py-2 md:py-[10px] ">
                                    ...
                                    <div readOnly type='text' className="w-full p-2 text-[13px] outline-none">{profileApiData?.gender}</div>
                                </div>
                            </div>
                            <div className="block w-[90%] mx-auto py-2 lora text-[14px] tracking-[1.5px]">
                                <div className="flex flex-col items-start justify-center w-full py-2 md:py-[10px] ">
                                    ...
                                    <div readOnly type='text' className="w-full p-2 text-[13px] outline-none">{profileApiData?.dob}</div>
                                </div>
                            </div>
                            <div className="block w-[90%] mx-auto py-2 lora text-[14px] tracking-[1.5px]">
                                <div className="flex flex-col items-start justify-center w-full py-2 md:py-[10px] ">
                                    ...
                                    <div readOnly type='text' className="w-full p-2 text-[13px] outline-none">{profileApiData?.email}</div>
                                </div>
                            </div>
                            <div className="block w-[90%] mx-auto py-2 lora text-[14px] tracking-[1.5px]">
                                <div className="flex flex-col items-start justify-center w-full py-2 md:py-[10px] ">
                                    ...
                                    <div readOnly type='text' className="w-full p-2 text-[13px] outline-none">{profileApiData?.phone_no}</div>
                                </div>
                            </div>
                            {/* {
                    ...
                    <form onSubmit={editProfile} className='w-[80%] md:w-[30%] mx-auto px-2 '>
                        <div className='flex justify-between items-center'>
                            <div className='' onClick={() => setGender('M')}>
                                ...
                                <input ref={genderRef} defaultChecked={profileApiData?.gender?.includes('M') ? true : false} className='text-[13px] outline-none p-1 accent-[#696969] ' htmlFor='male' type="radio" name='gender' />
                            </div>
                            <div className='' onClick={() => setGender('F')}>
                                <label className='text-[13px] mr-2' htmlFor="name">Female</label>
                                <input ref={genderRef} defaultChecked={profileApiData?.gender?.includes('F') ? true : false} className='text-[13px] outline-none p-1 accent-[#696969] ' htmlFor='female' type="radio" name='gender' />
                            </div>
                            <div className='' onClick={() => setGender('O')}>
                                <label className='text-[13px] mr-2' htmlFor="name">Others</label>
                                <input ref={genderRef} defaultChecked={profileApiData?.gender?.includes('O') ? true : false} className='text-[13px] outline-none p-1 accent-[#696969] ' htmlFor='others' type="radio" name='gender' />
                            </div>
                        </div>
                        <div className='w-full flex flex-col my-8'>
                            <label className='text-[13px] pb-1' htmlFor="name">Name</label>
                            <input ref={nameRef} className='text-[13px] outline-none py-2 pl-2' type="text" defaultValue={profileApiData?.name} />
                        </div>
                        <div className='w-full flex flex-col my-8'>
                            <label className='text-[13px] pb-1' htmlFor="name">Date of Birth</label>
                            <input ref={dobRef} className='text-[13px] outline-none py-2 pl-2' type="date" defaultValue={profileApiData?.dob}/>
                        </div>
                        <div className='w-full flex flex-col my-8'>
                            <label className='text-[13px] pb-1' htmlFor="name">Email</label>
                            <input ref={emailRef} className='text-[13px] outline-none py-2 pl-2' type="email" defaultValue={profileApiData?.email}/>
                        </div>
                        <div className='w-full flex flex-col my-8'>
                            <label className='text-[13px] pb-1' htmlFor="name">Region Code</label>
                            <input ref={countryCodeRef} className='text-[13px] outline-none py-2 pl-2' type="text" defaultValue={profileApiData?.phone_code}/>
                        </div>
                        <div className='w-full flex flex-col my-8'>
                            <label className='text-[13px] pb-1' htmlFor="name">Phone Number</label>
                            <input ref={numberRef} className='text-[13px] outline-none py-2 pl-2' type="number" min={0} defaultValue={profileApiData?.phone_no}/>
                        </div>
