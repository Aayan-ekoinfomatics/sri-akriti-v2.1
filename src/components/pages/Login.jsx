...
const Login = () => {
  ...
  return (
    <div className='flex flex-col gap-4 md:gap-0 md:flex-row justify-evenly px-5 mt-16 mb-16 md:mt-[220px] md:mb-[250px] w-[98%] md:w-[90%] mx-auto'>
      ...
      <form onSubmit={formSubmit} className='md:px-8 flex-1 flex flex-col items-center justify-evenly md:mx-5 md:max-w-[450px] md:max-h-[450px]  bg-[#E3E3E3] lg:py-10'>
        ...
        <div className='flex flex-col justify-evenly gap-4 w-[70%]'>
          ...
          <button className='bg-black text-white p-3 px-12 text-[14px] poppins tracking-[4px] font-[300]'>LOGIN</button>
        </div>
      </form>
    </div>
  )
